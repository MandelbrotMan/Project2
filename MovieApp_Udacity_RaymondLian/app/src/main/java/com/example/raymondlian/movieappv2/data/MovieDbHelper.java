...
public class MovieDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_MOVIE_TABLE = "CREATE TABLE " + MovieEntry.TABLE_NAME + " (" +
                ...
                MovieEntry.COLUMN_CURRENT_LIST + " INTEGER NOT NULL, " +
                MovieEntry.COLUMN_FAV_STAT + " INTEGER NOT NULL, " +
                MovieEntry.COLUMN_ID + " TEXT NOT NULL, " +
                MovieEntry.COLUMN_IMG_URL + " INTEGER NOT NULL," +

                MovieEntry.COLUMN_RELEASE_DATE + " REAL NOT NULL, " +
                MovieEntry.COLUMN_SYNOPSIS + " REAL NOT NULL, " +
